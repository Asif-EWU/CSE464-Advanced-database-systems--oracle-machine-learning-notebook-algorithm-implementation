...
CREATE OR REPLACE VIEW survival_prediction_logistic AS
    SELECT passengerid, PREDICTION(LOGISTIC_REGRESSION USING *) PREDICTION_SURVIVED, SURVIVED ACTUAL_SURVIVED
...
BEGIN
    ...
    FROM survival_prediction_logistic;
    
    select count(*) into correct_row
    from survival_prediction_logistic a
